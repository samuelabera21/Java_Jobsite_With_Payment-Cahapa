...
<head>
    ...
    <style>
        /* Copy all the CSS styles from seeker's editProfile.jsp */
        /* Just change the colors and icons to match employer theme */
...
<body>
    ...
    <div class="dashboard-container">
        ...
        <div class="edit-profile-container">
            ...
            <% if ("1".equals(successMsg)) { %>
                <div class="alert success fade-in">
                    ...
                    <div class="alert-content">
                        ...
                        <p>Your company profile has been saved.</p>
                    </div>
                </div>
            <% } %>
            ...
            <div class="profile-edit-card">
                ...
                <form action="<%= contextPath %>/employer/editProfile" 
                      method="post" 
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   ...
                                   name="companyName" 
                                   class="form-control" 
                                   value="<%= profile != null ? profile.getCompanyName() : "" %>" 
                        ...
                        <div class="form-group full-width">
                            <label for="bio" class="form-label">
                                <i class="fas fa-file-alt"></i> Company Bio
                            </label>
                            <textarea id="bio" 
                                      name="bio" 
                                      class="form-control" 
                                      rows="5"
                                      placeholder="Describe your company, mission, values, culture, etc."><%= profile != null && profile.getBio() != null ? profile.getBio() : "" %></textarea>
                        </div>
                        
                        <!-- Profile Photo -->
                        <div class="form-group full-width">
                            <label class="form-label">
                                <i class="fas fa-camera"></i> Company Logo / Profile Photo
                            </label>
                            ...
                            <div class="photo-upload-section">
                                ...
                                <div class="photo-instructions">
                                    Upload a company logo or profile photo (JPG, PNG, Max 2MB)
                                </div>
        ...
        <footer class="dashboard-footer">
            <p>&copy; 2025 JobPortal - Edit Company Profile. All rights reserved.</p>
            <div class="footer-links">
                <a href="<%= contextPath %>/employer/dashboard"><i class="fas fa-home"></i> Dashboard</a>
                <span></span>
                <a href="<%= contextPath %>/employer/profile"><i class="fas fa-building"></i> View Profile</a>
                <span></span>
    ...
    var EditProfile = {
            ...
            if (input.files && input.files[0]) {
                ...
                reader.onload = function(e) {
                    ...
                    if (!preview) {
                        ...
                        var photoContainer = document.querySelector('.current-photo');
                        if (photoContainer) {
        ...
        showLoading: function() {
            ...
            overlay.innerHTML = '<div style="background: var(--bg-card); padding: 30px; border-radius: var(--radius-xl); text-align: center; border: 1px solid var(--border-light);"><i class="fas fa-spinner fa-spin" style="font-size: 2rem; color: #4f46e5;"></i><p style="margin-top: 15px; color: var(--text-primary);">Saving Profile...</p></div>';
